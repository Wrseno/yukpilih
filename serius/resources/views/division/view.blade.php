...
<meta charset="utf-8">
  ...
  <title>YukPilih 3 | Data Division</title>
<head>
...
<div class="col-12 mt-5">
                    ...
                    <tr>
                      ...
                      <td>
                        <form action="#" method="post">
                          ...
                          @csrf 
                          @method("DELETE")
                          <a type="submit" class="btn btn-danger delete" data-id="{{ $d->id }}" data-nama="{{ $d->name }}">
    ...
    <script>
        $('.delete').click( function() {
            let namaDivision = $(this).attr('data-nama');
            let idDivision = $(this).attr('data-id');
            swal({
                    title: "Apakah Kamu Yakin?",
                    text: `Kamu Akan Menghapus Division ${namaDivision} !`,
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = `/deletedivision/${idDivision}`
